...
namespace GomokuBot.AI
{
    ...
    public class EvaluateV3:IEvaluate
    {
        ...
        public double evaluateBoardForWhite(GomokuBot.Board board, Boolean blacksTurn)
        {
            evaluationCount++;
        ...
        public List<List<int>> GetListAllDirection(GomokuBot.Board board, Position checkPosition, GomokuBot.Board.CellValue cellValue)
        {
        ...
        public int heuristic(GomokuBot.Board newBoard)
        {
            // GetPlayerscore from latest position
            Position LatestPosition = newBoard.LastPositionPut;

            GomokuBot.Board.CellValue PlayercellValue = (GomokuBot.Board.CellValue)newBoard.Matrix[LatestPosition.Row , LatestPosition.Col];
            List<List<int>> listAreaCheckForPlayer = GetListAllDirection(newBoard, LatestPosition, PlayercellValue);

            bool isForBlack = (PlayercellValue == GomokuBot.Board.CellValue.Black);
            ...
            GomokuBot.Board.CellValue opponentCellValue = (GomokuBot.Board.CellValue)
                                              (-(int)PlayercellValue);
            ...
            isForBlack = (opponentCellValue == GomokuBot.Board.CellValue.Black);
        ...
        public List<int> GetCellValueInDirection(int[,] matrix, GomokuBot.Board.CellValue cellValue, Position positionCheck, Position positionDelta)
        {
            int i;
        ...
        public int getScore(GomokuBot.Board board)
        {
        ...
        public double evaluateBoard(GomokuBot.Board board, bool IsMyturn)
        {

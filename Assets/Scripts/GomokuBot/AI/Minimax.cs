...
namespace GomokuBot.AI
{
    public class Minimax
    {
        ...
        private GomokuBot.Board board;
        public ILog log = null;
        public Minimax(GomokuBot.Board board, IEvaluate pEvaluater, ILog log)
        {
        ...
        public Position calculateNextMove(int depth)
        {
            ...
            if (board.IsEmpty)
            {
                botMoveScore.Row = Randomizer.GetRandomNumber(0, board.Matrix.GetUpperBound(0));
                botMoveScore.Col = Randomizer.GetRandomNumber(0, board.Matrix.GetUpperBound(1));
                //bestMove.Row =
                evaluationCount = 0;
        ...
        public class miniMaxParameter
        {
            ...
            public GomokuBot.Board board { get; set; }
        ...
        private MoveScore minimaxSearchAlphaBeta(int depth, GomokuBot.Board board, Boolean IsMax, double AlphaValue, double BetaValue)
        {
            NumberOfNodes++;
        ...
        public MoveScore searchBotWinningPosition(GomokuBot.Board board, IEvaluate bot)
        {
            ...
            {
                evaluationCount++;
                GomokuBot.Board tempBoard = new GomokuBot.Board(board);
        ...
        public MoveScore searchOpponentWinningPosition(GomokuBot.Board board, IEvaluate bot)
        {

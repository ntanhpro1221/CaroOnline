...
namespace GomokuBot
{
    ...
    public class Board
    {
         ...
         */
        public Dictionary<String, GomokuBot.Position> dicWhiteStone { get; private set; } = new Dictionary<String, GomokuBot.Position>();
        public Dictionary<String, GomokuBot.Position> dicBlackStone { get; private set; } = new Dictionary<String, GomokuBot.Position>();
        public Dictionary<String, GomokuBot.Position> dicNeighbor { get; private set; } = new Dictionary<string, Position>();
        ...
        private Dictionary<String, GomokuBot.Position> GetHshByCellValue(CellValue cellValue)
        {
        ...
        public void PutStone(int pRow, int pCol)
        {
            ...
            GomokuBot.Position newPosition = new Position(pRow, pCol);
